...
const EditProfile = () => {
  ...
  return (
    <div className="flex items-center justify-center h-[90vh] bg-slate-600">
      <form
        onSubmit={onFormSubmit}
        className="flex flex-col justify-center gap-5 rounded-lg p-4 bg-slate-700 text-white w-80 min-h-[26rem] shadow-[0_0_10px_black]"
      >
