...
const Profile = () => {
  ...
  return (
    <div className="min-h-[90vh] flex items-center justify-center bg-slate-600">
      <div className="my-10 flex flex-col gap-4 rounded-lg p-4 bg-slate-700 text-white w-96 shadow-[0_0_10px_black]">
        <img
