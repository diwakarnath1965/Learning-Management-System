...
function AdminDashboard() {
    ...
    return (
            ...
            <div className="min-h-[90vh] pt-5 flex flex-col flex-wrap gap-10 text-white bg-slate-700">
                                    ...
                                    return (
                                        <tr key={course._id}>
                                            ...
                                            <td className="flex items-center gap-4">
                                                <button
                                                    className="bg-green-500 hover:bg-green-600 transition-all ease-in-out duration-300 text-xl py-5 px-4  rounded-md font-bold"
                                                    onClick={() => navigate("/course/displaylectures", {state: {...course}})}
                                                >
                                                    <BsCollectionPlayFill />
                                                </button>
                                                <button
                                                    className="bg-red-500 hover:bg-red-600 transition-all ease-in-out duration-300 text-xl py-5 px-4 pb  rounded-md font-bold"
